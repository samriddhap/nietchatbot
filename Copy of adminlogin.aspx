<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of adminlogin.aspx.cs" Inherits="_Default"
            ...
            <div class="container">
                <div class="col-md-8 contact-left cont">
                    <div class="contct-info">
                        ...
                        <div class="row">
                            <div class="col-md-6 row-grid">
                                <asp:TextBox ID="TextBox1" runat="server" placeholder="Email" runat="server" ToolTip="Email"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="UName"
                                    ErrorMessage="Email is required." ToolTip="User Name is required.">*</asp:RequiredFieldValidator>
                            </div>
                            <div class="col-md-6 row-grid">
                                <input type="text" id="Text1" placeholder="Password" runat="server" required>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Pwd"
                                    ErrorMessage="Password is required." ToolTip="Password is required.">*</asp:RequiredFieldValidator>
                            </div>
                            <div class="clearfix">
                            </div>
